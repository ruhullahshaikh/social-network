		...
		<?php
			if(isset($_POST['send_msg'])){
				...
				if($msg == ""){
					...
					echo"<h4 style='color:red;text-align:center;'>Message is Too long! Use only 500 characters</h4>";
				}
				else{
		...
		<?php
			...
			echo "
				<div class='row'>
					...
					<img class='img-circle' src='../images/$user_image' width='150' height='150' />
					<br><br>
					<ul class='list-group'>
